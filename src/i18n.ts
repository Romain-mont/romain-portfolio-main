    ...
    resources: {
      fr: {
        translation: {
          ...
          description: "Après 6 ans d'expérience commerciale et une aventure internationale en Nouvelle-Zélande, je me reconvertis dans le développement web. Actuellement en formation Concepteur Développeur d'Applications chez O'clock, je combine ma perspective business avec mes nouvelles compétences techniques.",
          
          // Education
          educationTitle: 'Éducation',
          formation: "O'clock — Concepteur Développeur d'Applications (reconversion professionnelle)",
          lvExperience: 'Conseiller Clientèle — Louis Vuitton, Nouvelle-Zélande',
          danoneExperience: 'Assistant développement des ventes — Danone, Paris',
          ...
          harryPotterDesc: "Ce projet a été développé pour pratiquer les API REST, l'authentification et React.",
          seniorLoveDesc: "Senior Love, une plateforme de rencontres en ligne combinée à des événements locaux. Ce projet s'adresse aux retraités actifs de plus de 60 ans en quête de nouvelles rencontres et de moments de partage.",
...
J'ai voulu pratiquer tout ce que j'ai vu au cours de ma formation, en combinant front-end, back-end, et gestion de base de données pour créer une application complète.`,
          ...
          contactDescription: 'Envie d\'échanger sur un projet, une collaboration ou simplement discuter tech ? N\'hésite pas à me contacter !',
          name: 'Nom',
          email: 'Email',
          message: 'Message',
          sending: 'Envoi...',
          ...
          errorMessage: 'Oups ! Une erreur est survenue. Réessaie ou contacte-moi par email.',
          
          // Footer
          madeWith: 'Portfolio réalisé avec React, Tailwind CSS & Flowbite React.',
        },
      },
      en: {
        translation: {
          ...
          description: "After 6 years of commercial experience and an international adventure in New Zealand, I'm transitioning into web development. Currently training as an Application Developer at O'clock, I combine my business perspective with my new technical skills.",
          ...
          seeCode: 'View code',
          harryPotterDesc: "This project was developed to practice REST APIs, authentication, and React.",
          seniorLoveDesc: "Senior Love, an online dating platform combined with local events. This project targets active retirees over 60 looking for new connections and shared moments.",
...
I wanted to practice everything I learned during my training, combining front-end, back-end, and database management to create a complete application.`,
          ...
          // Contact
          contactTitle: 'Contact',
          contactDescription: 'Want to discuss a project, collaboration, or just chat about tech? Feel free to contact me!',
          name: 'Name',
          email: 'Email',
          message: 'Message',
          sending: 'Sending...',
          ...
          errorMessage: 'Oops! An error occurred. Please try again or contact me by email.',
